...
```bash
# 5.1 사설 하버 인프라 레지스트리 IP 및 포트 정보 등록
HARBOR_HOST="10.185.40.43:30002"
...
> ```
> 또한 4.3단계에서 조정한 `registry.k8s.io/pause:3.10` 부분도 폐쇄망 환경 사양에 맞춘다면 수동으로 위의 Harbor 내부 미러링 경로(`10.185.40.43:30002/k8s.io/pause:3.10` 등)로 대체 구성해 주는 조치도 유용해요.
