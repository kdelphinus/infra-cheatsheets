...
> **작성일**: 2026-05-08
> **참고 가이드**: [install-guide.md](../install/rocky-9/v1.30/offline-install.md), [install-guide-online.md](../install/rocky-9/v1.30/online-install.md)
...
- 영구 손상 시 [install-guide.md](../install/rocky-9/v1.30/offline-install.md) 의 etcd 복원 / 마스터 재합류 절차 참조
...
> - 사전에 [install-guide.md](../install/rocky-9/v1.30/offline-install.md) 의 검증 명령을 한 번 더 훑어두면 좋습니다.
