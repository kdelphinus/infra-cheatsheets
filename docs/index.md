...
- **Gateway API**: [Envoy 설치](k8s/gateway-api/001-envoy-install.md) · [Ingress 변환](k8s/gateway-api/002-convert_ingress_to_httproute.md)

### ☁️ OpenStack
**Private Cloud 인프라 관리**
