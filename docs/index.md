...
- :simple-kubernetes: **Kubernetes**
  ...
  **Monitoring**
  ...
  [운영 가이드](k8s/monitoring/002-operation-guide.md)
...
- :simple-openstack: **OpenStack**
  ...
  **운영 & 트러블슈팅**
  [Cloud-init](openstack/utils/cloud-init.md) ·
  [Golden Image](openstack/utils/golden-image.md) ·
  [K8s 네트워크 장애 해결](openstack/troubleshooting/k8s-network-error.md) ·
  [Ironic 추가](openstack/tools/add-ironic.md)
